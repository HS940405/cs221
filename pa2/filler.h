...
namespace filler
{
  ...
  */
  ...
  bool isMarked(vector<vector<bool>> vec, PixelPoint point);

  bool checkTolerance(PixelPoint point, double tol, RGBAPixel color);

  void colorImg(RGBAPixel* pixel, PixelPoint point);

  vector<int> toVector(PixelPoint point);
